...
const SimliOpenAI = React.forwardRef<
  { handleStart: () => Promise<void>; handleStop: () => void },
  SimliOpenAIProps
>(({ simli_faceid, openai_voice, initialPrompt, onStart, onClose, showDottedFace }, ref) => {
  // State management
      ...
      <div className="flex flex-col items-center">
        {!isAvatarVisible ? (
          <button
            ...
            disabled={isLoading}
            className={cn(
              "w-full h-[52px] mt-4 disabled:bg-[#343434] disabled:text-white disabled:hover:rounded-[100px] bg-black text-white py-3 px-6 rounded-[100px] transition-all duration-300 hover:text-white hover:bg-gray-800 hover:rounded-sm",
          ...
          <>
            <div className="flex items-center gap-4 w-full">
              <button
                onClick={handleStop}
                className={cn(
                  "mt-4 group text-white flex-grow bg-black hover:rounded-sm hover:bg-gray-800 h-[52px] px-6 rounded-[100px] transition-all duration-300"
                )}
              >
                <span className="font-abc-repro-mono text-white group-hover:text-white font-bold w-[164px] transition-all duration-300">
                  Stop Interaction
                </span>
              </button>
            </div>
